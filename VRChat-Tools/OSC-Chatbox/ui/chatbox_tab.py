...
class ChatboxTab(tk.Frame):
    def __init__(self, parent, cfg: dict, state, save_cb, start_cb, stop_cb, restart_cb, settings_cb, help_cb):
    ...
    def _build(self):
        ...
        for label, key, r, cl, ce in fields:
            tk.Label(cfg_frame, text=label, bg=BG, fg=SUBTEXT,
                     font=(FONT, 9), anchor="e").grid(row=r, column=cl, sticky="e", padx=(8, 4), pady=3)
            e = tk.Entry(
